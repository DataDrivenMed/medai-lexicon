...
// ═══════════════════════════════════════════════════════════════════════════
// Top bar (Updated with social links & name change)
// ═══════════════════════════════════════════════════════════════════════════
          ...
          <div className="brand-text">
            ...
            <div className="brand-sub" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              ...
              <div style={{ display: 'flex', gap: '8px', marginLeft: '4px' }}>
                ...
                <a href="https://datadrivenmed.github.io/" target="_blank" title="Gitpage" style={{ display: 'flex', color: 'inherit' }}>
