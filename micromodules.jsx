...
function ClinModule3() {
  return (<>
    ...
    <p style={styles.body}>Hallucinations are outputs where the conditional probability P(next token given previous tokens) is high — the model is confident — but the resulting sequence is factually incorrect. The model has <strong>no mechanism to distinguish between statistically likely and factually true</strong>.</p>
...
function ClinModule4() {
  return (<>
    ...
    <FormulaBlock>{"Top-p: sample from smallest set S where \u03A3 P(token_i) \u2265 p"}</FormulaBlock>
